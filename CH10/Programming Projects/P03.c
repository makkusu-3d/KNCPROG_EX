 ...
 * from the poker.c program of Section 10.5. Have the program
 * store the cards in a 5 x 2 array instead. Each row of the
 * array will represent a card. For example, if the array is named
 * hand, then hand [0][0] will store the rank of the first card
...
void analyze_hand(void)
{
    int flush_check, rank_check, rank_sum;
    int i = 0;
...
/*************************************************************
 * initialize_array:  writes specified value to all elements *
 *************************************************************/
void initialize_array(void) {
    int i, j;
    for (i = 0; i < 5; i++) {

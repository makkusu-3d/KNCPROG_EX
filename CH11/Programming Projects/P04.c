/**
 * Modify the poker.c program of Section 10.5 by moving all
 * external variables into main and modifying functions
 * so that they communicate by passing arguments. The
 * analyze_hand function needs to change the straights,
 * flush, four, three, and pairs variables, so it will
 * have to be passed pointers to whose variables.
 */
...
void analyze_hand(int *num_in_rank[*], int *num_in_suit[*], bool*, bool*, bool*, bool*, int*);

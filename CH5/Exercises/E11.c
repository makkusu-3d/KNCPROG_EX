/* The following table shows telephone area codes in the state of
 ...
 * statement will display the message "Area code no recognized". Use the
 * techniques discussed in Section 5.3 to make the switch statement as

 ...
 *
 * We can, however, achieve similar effects by using pointers:
 * a function can return a pointer to the first element in an
 * array, a function can return a pointer to a function
 * and the elements of an array can be pointers to functions.
